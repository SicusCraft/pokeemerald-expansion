...
static const u8 sDoorAnimTiles_SlidingSingleDoor[] = INCBIN_U8("graphics/door_anims/sliding_single.4bpp");
...
static const u8 sDoorAnimTiles_Pallet_Town[] = INCBIN_U8("graphics/door_anims/pallet.4bpp");
...
static const u8 sDoorAnimTiles_Viridian_City[] = INCBIN_U8("graphics/door_anims/viridian.4bpp");
...
static const u8 sDoorAnimPalettes_SlidingSingleDoor[] = {3, 3, 3, 3, 3, 3, 3, 3};
...
static const u8 sDoorAnimPalettes_Pallet_Town[] = {8, 8, 8, 8, 8, 8, 8, 8};
static const u8 sDoorAnimPalettes_Viridian_City[] = {8, 8, 8, 8, 8, 8, 8, 8};

static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    {METATILE_General_Door,                                 DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_General, sDoorAnimPalettes_General},
    {METATILE_General_SlidingSingleDoor,                    DOOR_SOUND_SLIDING, 0, sDoorAnimTiles_SlidingSingleDoor, sDoorAnimPalettes_SlidingSingleDoor},
    ...
    {METATILE_PalletTown_Door_OaksLab,                      DOOR_SOUND_NORMAL,  0, sDoorAnimTiles_OaksLab, sDoorAnimPalettes_OaksLab},    
    ...
    {METATILE_PalletTown_Door_Pallet,                       DOOR_SOUND_NORMAL,  0, sDoorAnimTiles_Pallet_Town, sDoorAnimPalettes_Pallet_Town},
    {METATILE_ViridianCity_Door_Viridian,                   DOOR_SOUND_NORMAL,  0, sDoorAnimTiles_Viridian_City, sDoorAnimPalettes_Viridian_City},
    {},
};
...
#define DOOR_TILE_START_SIZE_3 (NUM_TILES_TOTAL - 4)
...
static void CopyDoorTilesToVram(const struct DoorGraphics *gfx, const struct DoorAnimFrame *frame)
{
    if (gfx->size == 2)
        ...
        CpuFastCopy(gfx->tiles + frame->offset, (void *)(VRAM + TILE_OFFSET_4BPP(DOOR_TILE_START_SIZE_3)), 4 * TILE_SIZE_4BPP);
}
...
static void DrawCurrentDoorAnimFrame(const struct DoorGraphics *gfx, u32 x, u32 y, const u8 *paletteNums)
{
    ...
    {
        // Bottom metatile
        BuildDoorTiles(&tiles[0], DOOR_TILE_START_SIZE_3 + 0, &paletteNums[0]);
        DrawDoorMetatileAt(x, y, &tiles[0]);
    }
}
