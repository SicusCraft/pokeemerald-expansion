...
static const u8 sText_Trainer1WantsToBattle[] = _("¡Prepárate para un desafío\ncontra {B_TRAINER1_NAME_WITH_CLASS}!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_WALLYUSEDITEM]                        = COMPOUND_STRING("¡El Prof.Oak usó {B_LAST_ITEM}!"), //no decapitalize until it is everywhere
    ...
    [STRINGID_PLAYERPAIDPRIZEMONEYNOWHITEOUT]       = COMPOUND_STRING("{B_PLAYER_NAME} paid ¥{B_BUFF1} as the prize\nmoney…\p… … … …{PAUSE_UNTIL_PRESS}"),
    [STRINGID_PLAYERDROPPEDMONEYNOWHITEOUT]         = COMPOUND_STRING("{B_PLAYER_NAME} panicked and lost ¥{B_BUFF1}…\p… … … …{PAUSE_UNTIL_PRESS}"),
...
const u8 gText_WhatWillWallyDo[] = _("¿Qué hará el\nProf.Oak?");
