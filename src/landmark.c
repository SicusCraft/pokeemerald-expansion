...
static const u8 LandmarkName_ViridianForest[] = _("Bosque Verde");
...
static const struct Landmark Landmark_ViridianForest = {LandmarkName_ViridianForest, FLAG_LANDMARK_VIRIDIAN_FOREST};
