const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BLUE_EARLY] = TRAINER_PIC_BLUE_EARLY,
    [FACILITY_CLASS_KANTO_BUG_CATCHER] = TRAINER_PIC_KANTO_BUG_CATCHER,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BLUE_EARLY] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_KANTO_BUG_CATCHER] = TRAINER_PIC_KANTO_BUG_CATCHER,
};
